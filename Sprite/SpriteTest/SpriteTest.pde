...
void setup() {
  ...
  //The 'tank.png' image was downloaded from the following site: https://opengameart.org/content/top-down-vehicle
  tank = new Tank("tank.png", width * 0.5, height * 0.5, 120, 120);
  tank.frontAngle(-90);
  PImage pimage = tank.getImage();
  println(pimage != null);
}
