...
public class VerticalScrollBar extends Controller {
	...
	public void updateGraphics() {
		...
		pg.beginDraw();
		pg.rectMode(CORNER);
		pg.rect(0, upButton.h, upButton.w, h - upButton.h - downButton.h, r1, r2, r3, r4);
		pg.endDraw();
	}

	private void createButtons() {
		upButton = new DirectionButton(ktgui, "upBtn:" + title, 0, 0, w, w, UP);
		upButton.isDragable = false;
		attachController(upButton);

		downButton = new DirectionButton(ktgui, "downBtn:" + title, 0, h - w, w, w, DOWN);
